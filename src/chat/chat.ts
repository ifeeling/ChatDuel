...
function renderHistoryDetail(session?: Session) {
  ...
  deleteBtn.className = 'history-action danger icon-only'
  deleteBtn.title = t(userSettings.language, 'common.delete')
  deleteBtn.setAttribute('aria-label', t(userSettings.language, 'common.delete'))
  deleteBtn.innerHTML = TRASH_ICON_SVG
  deleteBtn.addEventListener('click', () => void deleteHistorySession(session.id))
  const actionsPrimaryRow = document.createElement('div')
  actionsPrimaryRow.className = 'history-actions-row'
  actionsPrimaryRow.append(exportHtmlBtn, deleteBtn)
  const actionsSecondaryRow = document.createElement('div')
  actionsSecondaryRow.className = 'history-actions-row'
  actionsSecondaryRow.append(copyBtn, exportBtn)
  actions.append(actionsPrimaryRow, actionsSecondaryRow)
